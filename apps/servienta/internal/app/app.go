...
import (
	...
	dnsrecv "github.com/servienta/servienta/apps/servienta/internal/receiver/dns"
	"github.com/servienta/servienta/apps/servienta/internal/receiver/ipfix"
	"github.com/servienta/servienta/apps/servienta/internal/receiver/kafka"
	"github.com/servienta/servienta/apps/servienta/internal/receiver/ntp"
	"github.com/servienta/servienta/apps/servienta/internal/receiver/radius"
	"github.com/servienta/servienta/apps/servienta/internal/receiver/reference"
	"github.com/servienta/servienta/apps/servienta/internal/receiver/snmptrap"
	"github.com/servienta/servienta/apps/servienta/internal/receiver/syslog"
	"github.com/servienta/servienta/apps/servienta/internal/receiver/tacacs"
	"github.com/servienta/servienta/apps/servienta/internal/sender"
	dnssnd "github.com/servienta/servienta/apps/servienta/internal/sender/dnssend"
	ipfixsnd "github.com/servienta/servienta/apps/servienta/internal/sender/ipfixsend"
	kafkasnd "github.com/servienta/servienta/apps/servienta/internal/sender/kafkasend"
	ntpsnd "github.com/servienta/servienta/apps/servienta/internal/sender/ntpsend"
	radiussnd "github.com/servienta/servienta/apps/servienta/internal/sender/radiussend"
	snmpsnd "github.com/servienta/servienta/apps/servienta/internal/sender/snmpsend"
	syslogsnd "github.com/servienta/servienta/apps/servienta/internal/sender/syslogsend"
	tacacssnd "github.com/servienta/servienta/apps/servienta/internal/sender/tacacssend"
)

type Config struct {
	ControlAddr    string // the contract, e.g. ":5001"; ":0" for ephemeral
	UIAddr         string // the embedded management SPA (D20); empty => not served
...
func Start(parent context.Context, cfg Config) (*App, error) {
	...
	ctlSrv := control.New(store, endpoints, lic, activeSenders, cfg.LicensePath)
	ctl, err := ctlSrv.Start(ctx, cfg.ControlAddr)
	if err != nil {
		cancel()
	...
	if cfg.UIAddr != "" {
		ui, err := ctlSrv.StartUI(ctx, cfg.UIAddr)
		if err != nil {
			cancel()
			return nil, fmt.Errorf("ui: %w", err)
		}
		endpoints["ui"] = ui.String()
	}
