...
func main() {
	cfg := app.Config{
		ControlAddr:    envOr("SERVIENTA_CONTROL_ADDR", ":5001"),
		UIAddr:         envOr("SERVIENTA_UI_ADDR", ":5000"),
		FilesHTTPAddr:  envOr("SERVIENTA_FILES_HTTP_ADDR", ":8080"),
		...
		DNSAddr:        envOr("SERVIENTA_DNS_ADDR", ":15353"),
