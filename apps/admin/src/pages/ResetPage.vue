...
<template>
  <div class="mx-auto mt-24 max-w-sm rounded-lg border border-zinc-200 bg-white p-6">
    ...
    <form class="mt-4 space-y-3" @submit.prevent="reset">
      <input v-model="next" type="password" required minlength="10" placeholder="New password (10+ chars)" class="w-full rounded-md border border-zinc-300 px-3 py-2 text-sm" />
